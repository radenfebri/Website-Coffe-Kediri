...
Route::middleware(['has.role'])->middleware('auth', 'verified')->group(function () {
    ...
    Route::get('privacy-policy-admin', [KebijakanPrivacy::class, 'privacy_policy'])->name('privacy-policy-admin.index');
    Route::post('privacy-policy-admin', [KebijakanPrivacy::class, 'privacy_policy_store'])->name('privacy-policy-admin.store');
    Route::put('privacy-policy-admin/{id}/update', [KebijakanPrivacy::class, 'privacy_policy_update'])->name('privacy-policy-admin.update');
    
    // ROUTE TERMS CONDITIONS
    Route::get('terms-conditions-admin', [KebijakanPrivacy::class, 'terms_conditions'])->name('terms-conditions-admin.index');
    Route::post('terms-conditions-admin', [KebijakanPrivacy::class, 'terms_conditions_store'])->name('terms-conditions-admin.store');
    Route::put('terms-conditions-admin/{id}/update', [KebijakanPrivacy::class, 'terms_conditions_update'])->name('terms-conditions-admin.update');
    
    // ROUTE ABOUT COMPANY
    Route::get('about-company', [AboutAndContactController::class, 'about_company'])->name('about-company.index');
    Route::post('about-company', [AboutAndContactController::class, 'about_company_store'])->name('about-company.store');
    Route::put('about-company/{id}/update', [AboutAndContactController::class, 'about_company_update'])->name('about-company.update');
    
    // ROUTE CONTACT COMPANY
    Route::get('contact-company', [AboutAndContactController::class, 'contact_company'])->name('contact-company.index');
    Route::get('contact-company/{id}/show', [AboutAndContactController::class, 'contact_company_show'])->name('contact-company.show');
    Route::get('contact-company/destroy/{id}', [AboutAndContactController::class, 'contact_company_destroy'])->name('contact-company.destroy');
    
    // ROUTE SETTING INFO WEBSITE
    Route::get('setting-info-website', [SettingWebsiteController::class, 'setting_info_website'])->name('setting-info-website.index');
    Route::post('setting-info-website', [SettingWebsiteController::class, 'setting_info_website_store'])->name('setting-info-website.store');
    Route::put('setting-info-website/{id}/update', [SettingWebsiteController::class, 'setting_info_website_update'])->name('setting-info-website.update');
