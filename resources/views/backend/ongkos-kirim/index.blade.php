                        ...
                        <div class="widget-content widget-content-area blog-create-section">
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" name="kecamatan" value="{{ old('kecamatan') }}" class="form-control @error('kecamatan') is-invalid @enderror" id="post-title" placeholder="Grogol">
                                    @error('kecamatan')
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-12">
                                    <label>Harga Ongkir<span class="text-danger">*</span></label>
                                    <input type="number" name="harga" value="{{ old('harga') }}" class="form-control @error('harga') is-invalid @enderror" id="post-title" placeholder="20000">
                                    @error('harga')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <ul class="table-controls">
                                                ...
                                                <li>
                                                    <a href="{{ route('ongkir.edit', encrypt($item->id)) }}" class="bs-tooltip" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit">
                                                ...
                                                <li>
                                                    <a href="{{ route('ongkir.destroy', encrypt($item->id)) }}" onclick="return confirm('Yakin anda akan menghapus rekening {{ $item->kategori }}?')" class="bs-tooltip" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" data-original-title="Delete">
