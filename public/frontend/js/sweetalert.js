!(function (e, t) {
    ...
    const Gt = ["swal-title", "swal-html", "swal-footer"],
        ...
        cn = (e) => {
            ...
            if (e.target === t) {
                const n = g();
                t.removeEventListener(Be, cn), (n.style.overflowY = "show");
            }
        },
        ln = (e, t) => {
            Be && de(t)
                ? ((e.style.overflowY = "show"), t.addEventListener(Be, cn))
                : (e.style.overflowY = "show");
        },
        un = (e, t, n) => {
            st(),
                t && "show" !== n && ut(),
